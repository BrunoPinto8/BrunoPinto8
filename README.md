...
- Preparação de propostas e resposta a RFPs
- Condução de entrevistas e pipeline de recrutamento

### 🔍 Competências principais:
- **Gestão de Testes**: SIT, UAT, regressão, integração
- **Ferramentas**: Azure DevOps, Jira, ALM
- **Automação**: Selenium, Robot Framework, Cypress, Postman, RestAssured
- **Metodologias**: Agile, Scrum, CI/CD
- **Pre-Sales & Operações**: workload planning, propostas, RFPs

🎯 **Interesses:** automação, testes exploratórios, gestão de defeitos, IA aplicada à qualidade, DevOps.
...
- Proposal preparation and RFP responses
- Recruitment and candidate pipeline management

### 🔍 Key Skills:
- **Test Management**: SIT, UAT, regression, integration
- **Tools**: Azure DevOps, Jira, ALM
- **Automation**: Selenium, Robot Framework, Cypress, Postman, RestAssured
- **Methodologies**: Agile, Scrum, CI/CD
- **Pre-Sales & Operations**: workload planning, proposals, RFPs
